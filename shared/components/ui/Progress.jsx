...
export const Progress = ({ value, max = 100, className, size = 'md', variant = 'default', showLabel = false, label, }) => {
    const percentage = Math.min(Math.max((value / max) * 100, 0), 100);
    return (<div className={cn('w-full', className)}>
            {(showLabel || label) && (<div className="flex justify-between text-sm text-gray-400 mb-1">
