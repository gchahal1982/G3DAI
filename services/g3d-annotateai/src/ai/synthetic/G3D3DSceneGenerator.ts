...
export class G3D3DSceneGenerator {
    ...
    constructor() {
        ...
        this.sceneManager = new G3DSceneManager();
    ...
    private initializeMaterialLibrary(): void {
        const materials = {
            concrete: { albedo: [0.7, 0.7, 0.7], metallic: 0.0, roughness: 0.8, emission: [0, 0, 0] },
            metal: { albedo: [0.8, 0.8, 0.8], metallic: 1.0, roughness: 0.2, emission: [0, 0, 0] },
            wood: { albedo: [0.6, 0.4, 0.2], metallic: 0.0, roughness: 0.7, emission: [0, 0, 0] },
            glass: { albedo: [0.9, 0.9, 0.9], metallic: 0.0, roughness: 0.1, emission: [0, 0, 0] },
            plastic: { albedo: [0.5, 0.5, 0.5], metallic: 0.0, roughness: 0.5, emission: [0, 0, 0] },
            fabric: { albedo: [0.4, 0.4, 0.6], metallic: 0.0, roughness: 0.9, emission: [0, 0, 0] },
            asphalt: { albedo: [0.2, 0.2, 0.2], metallic: 0.0, roughness: 0.9, emission: [0, 0, 0] },
            grass: { albedo: [0.2, 0.6, 0.2], metallic: 0.0, roughness: 0.8, emission: [0, 0, 0] }
        };
