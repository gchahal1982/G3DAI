...
export class G3DObjectDetectionModel {
    ...
    private async preprocessImage(
        ...
        const preprocessShader = await this.computeShaders.createComputeShader(`
    ...
    `);
        ...
        await this.computeShaders.dispatch(preprocessShader, {
            workgroups: [
    ...
    private async runInference(
        ...
        const outputs = await this.modelRunner.executeModel(compiledModel, {
            inputs: [input],
