 ...
 */
export class G3DXRAnnotation extends EventEmitter {
    ...
    private annotations: Map<string, XRAnnotation> = new Map();
    ...
    private async initializeSubsystems(): Promise<void> {
        ...
        if (this.config.enableVoiceInput) {
            await this.voiceRecognizer.initialize();
        }
        ...
        await this.annotationRenderer.initialize();
     ...
     * Update annotation
     */
    public updateAnnotation(id: string, updates: Partial<XRAnnotation>): boolean {
    ...
    private updateAnnotationSpatialData(annotation: XRAnnotation): void {
...
class XRAnnotationRenderer {
    async initialize(): Promise<void> { }
    render(annotations: Map<string, XRAnnotation>, viewMatrix: Float32Array, projectionMatrix: Float32Array, viewerPosition: XRVector3): void { }
    dispose(): void { }
}
...
export default G3DXRAnnotation;