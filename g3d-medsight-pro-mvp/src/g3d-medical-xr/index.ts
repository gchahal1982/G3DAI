...
export class G3DMedicalXRManager {
    ...
    dispose(): void {
        ...
        if (this.vrSystem) {
            this.vrSystem.dispose();
            this.vrSystem = null;
        }

        if (this.arSystem) {
            this.arSystem.dispose();
            this.arSystem = null;
        }
        ...
        if (this.collaborativeSystem) {
            this.collaborativeSystem.dispose();
            this.collaborativeSystem = null;
        }

        if (this.hapticsSystem) {
            this.hapticsSystem.dispose();
