...
import { G3DSceneManager, G3DSceneNode } from './G3DSceneManager';
import { G3DMaterial, G3DMaterialSystem } from './G3DMaterialSystem';
import { G3DGeometry, G3DGeometryProcessor } from './G3DGeometryProcessor';
import { G3DLight, G3DLightingSystem } from './G3DLightingSystem';
...
export class Object3D {
    ...
    add(child: Object3D): this {
        ...
        if (this._g3dNode && child._g3dNode) {
            const sceneManager = (window as any).g3dSceneManager as G3DSceneManager;
            if (sceneManager) {
...
export class Mesh extends Object3D {
    ...
    private createG3DRenderObject(): void {
        ...
        if (this.geometry && this.material) {
            const renderObject: G3DRenderObject = {
                id: this._g3dNode.id,
...
export class BufferGeometry {
    ...
    // G3D internals
    _g3dGeometry: G3DGeometry | null = null;
    ...
    setAttribute(name: string, attribute: BufferAttribute): this {
        ...
        if (this._g3dGeometry) {
            const geometryProcessor = (window as any).g3dGeometryProcessor as G3DGeometryProcessor;
...
export class MeshBasicMaterial extends Material {
    ...
    constructor(params?: any) {
        ...
        // Create G3D material
        const materialSystem = (window as any).g3dMaterialSystem as G3DMaterialSystem;
        if (materialSystem) {
...
export class DirectionalLight extends Light {
    constructor(color?: number | string, intensity: number = 1) {
        ...
        // Create G3D light
        const lightingSystem = (window as any).g3dLightingSystem as G3DLightingSystem;
        if (lightingSystem) {
...
export class PerspectiveCamera extends Object3D {
    ...
    updateProjectionMatrix(): void {
        // Update G3D camera
        const renderer = (window as any).g3dRenderer as G3DNativeRenderer;
        if (renderer) {
...
export class WebGLRenderer {
    ...
    // G3D internals
    private _g3dRenderer: G3DNativeRenderer | null = null;
    private _g3dSceneManager: G3DSceneManager | null = null;
    private _g3dMaterialSystem: G3DMaterialSystem | null = null;
    private _g3dGeometryProcessor: G3DGeometryProcessor | null = null;
    private _g3dLightingSystem: G3DLightingSystem | null = null;
    ...
    private initializeG3D(): void {
        // Create G3D renderer
        this._g3dRenderer = new G3DNativeRenderer(this.domElement, { antialias: true, alpha: true });
        this._g3dSceneManager = new G3DSceneManager(this._g3dRenderer);
        this._g3dMaterialSystem = new G3DMaterialSystem();
        this._g3dGeometryProcessor = new G3DGeometryProcessor();
        this._g3dLightingSystem = new G3DLightingSystem();
