    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Upload and manage your annotation datasets</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="glass p-6 rounded-xl">
            ...
            <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
              <ArrowUpTrayIcon className="h-12 w-12 text-gray-500 mx-auto mb-4" />
              <p className="text-gray-500">Drop videos here or click to browse</p>
            </div>
          </div>
          ...
          <div className="glass p-6 rounded-xl">
            ...
            <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
              <ArrowUpTrayIcon className="h-12 w-12 text-gray-500 mx-auto mb-4" />
              <p className="text-gray-500">Drop folders here or click to browse</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 glass p-6 rounded-xl">
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No uploads yet. Start by uploading your first dataset above.</p>
          </div>
        </div>
      </div>
    </div>
