...
export class MedicalParticleFactory {
    static createBloodFlow(config: Partial<BloodFlowConfig>): ParticleSystem {
    ...
    static createDrugDiffusion(config: Partial<DrugDiffusionConfig>): ParticleSystem {
    ...
    static createCellularVisualization(config: Partial<CellularConfig>): ParticleSystem {
