...
export class CollaborationEngine {
    ...
    public joinSession(sessionId: string, participant: Partial<Participant>): boolean {
        ...
        const newParticipant: Participant = {
            ...
            permissions: participant.permissions || CollaborationEngine.MEDICAL_ROLES[participant.role || 'observer'].permissions,
            status: 'active',
    ...
    private createDefaultAvatar(role: Participant['role']): Avatar {
        const roleConfig = CollaborationEngine.MEDICAL_ROLES[role];
