...
export class PostProcessing {
    ...
    private async loadMedicalEffects(): Promise<void> {
        ...
        this.createEffect({
            ...
            fragmentShader: PostProcessing.MEDICAL_SHADERS.EDGE_ENHANCEMENT,
            uniforms: new Map([
                ['u_edgeStrength', 1.0],
        ...
        this.createEffect({
            ...
            fragmentShader: PostProcessing.MEDICAL_SHADERS.CONTRAST_ENHANCEMENT,
            uniforms: new Map([
                ['u_contrast', 1.2],
                ['u_brightness', 1.0],
                ['u_gamma', 1.0],
        ...
        this.createEffect({
            ...
            fragmentShader: PostProcessing.MEDICAL_SHADERS.NOISE_REDUCTION,
            uniforms: new Map([
    ...
    private async loadStandardEffects(): Promise<void> {
        ...
        if (this.config.enableAntiAliasing && this.config.aaMethod === 'FXAA') {
            this.createEffect({
                ...
                enabled: true,
                order: 10,
                fragmentShader: PostProcessing.MEDICAL_SHADERS.FXAA,
                uniforms: new Map()
            });
        }
