...
export class AdvancedShaders {
    ...
    private async loadMedicalShaders(): Promise<void> {
        ...
        this.createShader({
            ...
            type: 'vertex',
            source: G3DAdvancedShaders.MEDICAL_SHADERS.VOLUME_RENDERING_VERTEX,
        ...
        this.createShader({
            ...
            type: 'fragment',
            source: G3DAdvancedShaders.MEDICAL_SHADERS.VOLUME_RENDERING_FRAGMENT,
            medicalSpecific: true
        });
        ...
        this.createShader({
            ...
            type: 'vertex',
            source: G3DAdvancedShaders.MEDICAL_SHADERS.MEDICAL_SURFACE_VERTEX,
            medicalSpecific: true
        });
        ...
        this.createShader({
            ...
            type: 'fragment',
            source: G3DAdvancedShaders.MEDICAL_SHADERS.MEDICAL_SURFACE_FRAGMENT,
            medicalSpecific: true
        });
