...
export class G3DLevelOfDetail {
    ...
    private calculateMedicalImportance(lodMesh: G3DLODMesh): number {
        ...
        const typeImportance = G3DLevelOfDetail.MEDICAL_IMPORTANCE_WEIGHTS[lodMesh.medicalType] || 0.5;
        ...
        for (const [term, weight] of Object.entries(G3DLevelOfDetail.MEDICAL_IMPORTANCE_WEIGHTS)) {
