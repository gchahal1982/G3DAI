...
const ComplianceDashboard: React.FC<ComplianceDashboardProps> = ({ soc2Manager }) => {
  ...
  const renderOverviewTab = () => (
    <Grid container spacing={3}>
      ...
      {/* @ts-ignore - MUI Grid type conflict */}
            ...
            <Box sx={{ width: { xs: '100%', md: '25%' } }}>
              <LocalizationProvider dateAdapter={AdapterDateFns}>
                <DatePicker
                  ...
                  onChange={(date: Date | null) => setAuditFilter(prev => ({ ...prev, dateFrom: date }))}
  ...
  const renderReportsTab = () => (
    <Box>
      ...
      <Grid container spacing={3}>
        {reports.map((report) => (
          <Box sx={{ width: { xs: '100%', md: '50%', lg: '33.33%' } }} key={report.id}>
            <Card>
              <CardContent>
              ...
              <Box sx={{ flex: 1 }}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DatePicker
                    ...
                    onChange={(date: Date | null) => setReportConfig(prev => ({ ...prev, startDate: date || new Date() }))}
              ...
              <Box sx={{ flex: 1 }}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DatePicker
                    ...
                    onChange={(date: Date | null) => setReportConfig(prev => ({ ...prev, endDate: date || new Date() }))}
                    slotProps={{ textField: { fullWidth: true } }}
                  />
                </LocalizationProvider>
              </Box>
