 ...
 * 
 * Revolutionary 3D code visualization engine with WebGL2 support
 * Features:
 * - WebGL2 rendering with modern shader pipeline
  ...
  private clear(): void {
    ...
    if (this.isWebGPU && this.context) {
      ...
      const renderPassEncoder = commandEncoder.beginRenderPass({
        colorAttachments: [{
          view: (this.context as unknown as GPUCanvasContext).getCurrentTexture().createView(),
