/**
 * G3DRenderer - Core 3D Rendering Engine for CodeForge
 * 
...
interface G3DScene {
  ...
  environment?: {
    type: 'skybox' | 'hdri';
    texture?: WebGPUTexture | WebGLTexture;
  };
}
...
interface G3DRenderTarget {
  ...
  width: number;
  height: number;
  colorTexture: WebGPUTexture | WebGLTexture;
  depthTexture: WebGPUTexture | WebGLTexture;
