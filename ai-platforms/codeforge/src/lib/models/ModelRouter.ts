/**
 * ModelRouter.ts - Intelligent model routing for CodeForge
 * 
...
export const CLOUD_MODELS: CloudModel[] = [
  {
    ...
    name: 'Kimi K2',
    provider: 'codeforge',
    endpoint: 'https://api.codeforge.ai/models/kimi-k2',
  ...
  },
  {
    ...
    name: 'DeepSeek R1',
    provider: 'codeforge',
    endpoint: 'https://api.codeforge.ai/models/deepseek-r1',
  ...
  private getCandidateModels(context: TaskContext, options: RoutingOptions): string[] {
    ...
    switch (type) {
      ...
      case 'architecture_design':
        ...
        if (options.allowFallback && this.currentHardware?.availableVRAM >= 48) {
