/**
 * InstallationWizard - CodeForge Setup Flow
 * 
  ...
  const renderBundleSelection = () => (
    <Grid container spacing={3}>
      {availableBundles.map((bundle) => (
        <Grid item xs={12} md={4} key={bundle.tier}>
          <Card 
            sx={{ 
              cursor: 'pointer',
  ...
  const renderCompletion = () => (
    <Box textAlign="center" py={4}>
      ...
      <Typography variant="body1" paragraph>
        CodeForge is now ready to use. Your models have been successfully installed and are ready for coding assistance.
      </Typography>
